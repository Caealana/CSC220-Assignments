...
{
    series1 = new DataSeries("Northampton");
    ...
    series2 = new DataSeries("Amherst");
    ...
    series3 = new DataSeries("Easthampton");
...
//console.log(series3.getData());

//each data series has all of the datapoints in an array and the name of the dataset
